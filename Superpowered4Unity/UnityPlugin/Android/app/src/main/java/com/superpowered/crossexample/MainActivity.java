...
import com.superpowered.SuperpoweredAndroid;

public class MainActivity extends AppCompatActivity {
    boolean playing = false;
    SuperpoweredAndroid SuperpoweredMan;
...
/*
        ...
        //SuperpoweredAndroid.TestLog();

        SuperpoweredMan= (SuperpoweredAndroid)SuperpoweredAndroid.createInstance(this);

        //SuperpoweredMan.Initialize(getPackageResourcePath(), params);
        SuperpoweredMan.register("Piano 1.wav");
        //SuperpoweredMan.register("Black.mp3");
        ...
        crossfader.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                SuperpoweredMan.onCrossfader(progress);
            }
        ...
        fxfader.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                SuperpoweredMan.onFxValue(progress);
            }

            public void onStartTrackingTouch(SeekBar seekBar) {
                SuperpoweredMan.onFxValue(seekBar.getProgress());
            }

            public void onStopTrackingTouch(SeekBar seekBar) {
                SuperpoweredMan.onFxOff();
            }
        });
        ...
        group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                ...
                SuperpoweredMan.onFxSelect(radioGroup.indexOfChild(checkedRadioButton));
            }
        });
    }
    ...
    public void SuperpoweredExample_PlayPause(View button) {  // Play/pause.
        playing = !playing;
        SuperpoweredMan.onPlayPause(playing);
